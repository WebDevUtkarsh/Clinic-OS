      ...
      <div className="flex min-h-14 items-center gap-3">
        ...
        <div className="hidden min-w-0 flex-1 justify-center lg:flex">
          <label className="flex h-11 w-full max-w-xl items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 dark:border-white/8 dark:bg-[#1F2937]">
            ...
            />
            <span className="rounded-full border border-gray-200 px-2 py-1 text-[11px] font-medium text-gray-400 dark:border-white/8 dark:text-[#6B7280]">
              Ctrl K
            </span>
          </label>
        </div>
                ...
                <div className="space-y-1">
                  {dashboardAlerts.slice(0, 3).map((alert) => (
                    <div
                      ...
                      className="rounded-2xl border border-gray-200 px-4 py-4 dark:border-white/6"
                    >
